...
(function (exports) {
    ...
    Model.inited = function (name) {
        ...
        if (!loadedModule[name]) {
            console.log("载入模块： "+MOD_DIR + name + '.js');
    ...
    (function () {
        ...
        req.onupgradeneeded = function (e) {
            ...
            if (_db.objectStoreNames.contains('project')) {
                ...
                projectStore.deleteIndex("idx_mul");
            }
            var projectStore = _db.createObjectStore("project", {keyPath: "id", autoIncrement: true});
            projectStore.createIndex("idx_name", "name", {unique:true});
            projectStore.createIndex("idx_last_time", "_last_time");
        };
    }());
