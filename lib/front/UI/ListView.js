...
(function ($) {
    ...
    function changeHandle(e) {
        ...
        if (tarName == "INPUT" || tarName == "SELECT") {
            ...
            var obj = this.data.get(row);
            obj[tar.name] = tar.type !="checkbox"?tar.value:tar.checked;
            this.data.set(row, obj);
        }
    }
    ...
    ListView.prototype.init = function() {
        this.container.addEventListener("change", changeHandle.bind(this), false);
